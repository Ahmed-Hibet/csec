            ...
            <form action="save_new_event.php" method="post">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="visible" value="all">All Members
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="visible" value="cpd">CPD Only
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="visible" value="cbd">CBD Only
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="visible" value="dd">DD Only
                        </div>
                    </div>
                </div>
                <div class="form-row">
