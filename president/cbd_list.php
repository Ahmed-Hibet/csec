...
<body>
    ...
    session_start();
        ...
        $sql = "SELECT * FROM `users` WHERE CBD = 'yes';";
        $cbd = $conn->query($sql);
    ?>
    <div id="main">
        ...
        <div>
            <h3>Capacity Building Devision</h3>
            <?php
                if($cbd->num_rows == 0){
                    echo "No Member";
                }
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                                 while($row=mysqli_fetch_assoc($cbd)){
                                     echo "<tr>";
                                     ...
                                     echo " <td>"; ?>
                                        <form action="delete_user.php" method="get">
                                            <input type="hidden" value="cbd" name="devision">
