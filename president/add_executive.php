...
<body>
    ...
    ?>
        ...
        <div class="event">
            <br>
            <h3>Add New Executive Commitee</h3>
            <form action="save_new_executive.php" method="post">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label>ID</label>
                        <input type="text" class="form-control" name="id" placeholder="Id of the member..." required>
                    </div>
                    <div class="form-group col-md-4">
                        <label>Roll</label>
                        <select class="custom-select" name="roll">
                            <option selected>Select roll of the executive</option>
                            <option value="vice president">Vice President</option>
                            <option value="cpd head">CPD Head</option>
                            <option value="cbd head">CBD Head</option>
                            <option value="dd head">DD Head</option>
                        </select>
                    </div>
                </div>
