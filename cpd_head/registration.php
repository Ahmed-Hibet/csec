...
<body>
    ...
    <div id="main">
        ...
        <?php
            $sql = "SELECT cpd FROM `registration`;";
            $cpd = $conn->query($sql);
            $row = mysqli_fetch_assoc($cpd);

            $sql = "SELECT * FROM `users` WHERE CPD = 'applied';";
            $cpd = $conn->query($sql);
            if($row['cpd'] == "yes"){
                ?>
                <div class="devisions">
                    <a href="cpd_list.php" class="cpd dev" style="text-decoration: none;">
                        ...
                        <p>CPD Registration is opened</p>
                    </a>
                </div>
                <?php
            }
                ...
                ?>
                <div class="devisions">
                    <a href="#" class="cpd dev" style="text-decoration: none;">
                        <?php echo "<h6> $cpd->num_rows</h6>"; ?>
                        <p>CPD Registration is closed</p>
                    </a>
                </div>
                <?php
            }
